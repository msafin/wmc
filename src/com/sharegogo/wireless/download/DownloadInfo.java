...
import com.sharegogo.wireless.download.Downloads.Impl;
...
public class DownloadInfo {
    public static class Reader {
        ...
        public void updateFromDatabase(DownloadInfo info) {
            ...
            info.mRequestType = getString(info.mRequestType,Downloads.Impl.COLUMN_REQUEST_TYPE);
            ...
            // Add these to support Authenticate download
            info.mUsername = getString(info.mUsername, Downloads.Impl.COLUMN_USERNAME);
            info.mPassword = getString(info.mPassword, Downloads.Impl.COLUMN_PASSWORD);
    ...
    //Add these three variables to support OMA DL
    ...
    /**
     * This string is used to support CU customization
    ...
    /**
     * Add this function to support CU customization
     * If user click "Yes", continue download.
     * If click "Cancel", abort download.
     */
    
    void notifyFileAlreadyExist() {
        Intent intent = new Intent(Intent.ACTION_VIEW);
        intent.setData(getAllDownloadsUri());
        intent.setClassName(SizeLimitActivity.class.getPackage().getName(),
                SizeLimitActivity.class.getName());
    ...
    //Add the follow BASIC Interceptor
    ...
    //Add the follow Digest Interceptor
