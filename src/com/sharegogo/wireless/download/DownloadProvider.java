...
public final class DownloadProvider extends ContentProvider {
    ...
    private static class SqlSelection {
        ...
        public <T> void appendClause(String newClause, final T... parameters) {
            if (newClause == null || newClause.contentEquals("")) {
                return;
            }
        ...
        private void createDownloadsTable(SQLiteDatabase db) {
            try {
                ...
                db.execSQL("CREATE TABLE " + DB_TABLE + "(" +
                        ...
                        Downloads.Impl.COLUMN_REQUEST_TYPE + " TEXT, " +
    ...
    public Uri insert(final Uri uri, final ContentValues values) {
        ...
        //add
        copyString(Downloads.Impl.COLUMN_REQUEST_TYPE, values, filteredValues);
        //end
    ...
    private void checkInsertPermissions(ContentValues values) {
        ...
        values.remove(Downloads.Impl.COLUMN_REQUEST_TYPE);
    ...
    public int update(final Uri uri, final ContentValues values,
        ...
        if (Binder.getCallingPid() != Process.myPid()) {
            ...
            if (filename != null) {
                ...
                if (!c.moveToFirst() || c.getString(0).contentEquals("")) {
