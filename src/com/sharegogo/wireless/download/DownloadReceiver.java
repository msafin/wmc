...
public class DownloadReceiver extends BroadcastReceiver {
    ...
    private void handleNotificationBroadcast(Context context, Intent intent) {
        ...
        try {
            ...
            if (action.equals(Constants.ACTION_OPEN)) {
                ...
                sendNotificationClickedIntent(context,intent,uri,cursor);
            } else { // ACTION_HIDE
                hideNotification(context, uri, cursor);
            }
        } finally {
     ...
     * @param cursor Cursor for reading the download's fields
     */
    private void sendNotificationClickedIntent(Context context,Intent intent, Uri uri, Cursor cursor) {
        ...
        if (isPublicApi) {
            ...
            appIntent.setDataAndType(uri, context.getContentResolver().getType(uri));
