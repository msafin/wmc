...
public class DownloadManager {
     ...
     * This is only used to OMA Download
     */
    public final static int ERROR_INVALID_DESCRIPTOR = 1010;
    ...
    public static class Request {
        ...
        private String mRequestType = HttpGet.METHOD_NAME;
         ...
         * @param uri the HTTP URI to download.
         */
        public Request(Uri uri,String type) {
            if (uri == null) {
                throw new NullPointerException();
            }
            String scheme = uri.getScheme();
        ...
        ContentValues toContentValues(String packageName) {
            ...
            values.put(Downloads.Impl.COLUMN_REQUEST_TYPE, mRequestType);
