...
public class HttpClientStack implements HttpStack {
	...
	public HttpResponse performRequest(Request<?> request,
		...
		if (url != null
				&& url.contentEquals(HttpConstants
						.getActionUrl(HttpConstants.ACTION_REGISTER))) {
			// do nothing
		} else {
			String token = SettingManager.getUser() + ":" + SettingManager.getPassword();
			String encoding = Base64.encodeToString(token.getBytes(),
					Base64.DEFAULT);
