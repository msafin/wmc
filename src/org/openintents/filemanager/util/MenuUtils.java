...
public abstract class MenuUtils {
	...
	public static boolean handleMultipleSelectionAction(final FileListFragment navigator, MenuItem mItem, List<FileHolder> fItems, Context context) {
		...
		switch (mItem.getItemId()) {
			...
			case R.id.menu_delete:
				...
				break;
			case R.id.menu_move:
				((SharegogoWirelessApp) navigator.getActivity().getApplication()).getCopyHelper().cut(fItems);
				...
				break;
			case R.id.menu_copy:
				((SharegogoWirelessApp) navigator.getActivity().getApplication()).getCopyHelper().copy(fItems);
	...
	public static boolean handleSingleSelectionAction(final SimpleFileListFragment navigator, MenuItem mItem, FileHolder fItem, Context context){
		...
		case R.id.menu_move:
			((SharegogoWirelessApp) navigator.getActivity().getApplication()).getCopyHelper().cut(fItem);
		...
		case R.id.menu_copy:
			((SharegogoWirelessApp) navigator.getActivity().getApplication()).getCopyHelper().copy(fItem);
